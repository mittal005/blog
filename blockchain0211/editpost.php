...
//    if(file_exists("gallery/$post_image"))
// {
...
<div class="row dash_row">
  ...
  <hr>
    <form class="" action='' method="post" enctype="multipart/form-data">
      <input type="hidden" name="fid_edit" id="fid_edit" value="<?php echo $fid;    ?>">
<input type="text" class="form-control" name="addTitle"  placeholder="Add Title" value="<?php echo $Title;   ?>">
  ...
  <div>
    Permalink:<a href=""><?php echo  $url_edit ; ?><span id="targetLayer"><?php echo $url_title;    ?></span></a>
  <!-- <input type="text" name="demo" id="demo" style="display: none"> -->
 <!--  <button onclick="myFunctionShow()">Edit</button> -->
 <input type="submit" name="add" id="add" value="edit">
 <div id="crud_table" style="display: none;">
  <input type="text" name="category_name" id="category_name" value="<?php echo $url_title;    ?>">
  <input type='submit'  value='ok'  id="uploadForm1">
<input type='submit'  value='clear' class='remove'>
</div>
</div>
...
<div class="card-header" id="seoone">
  ...
  <br>
  <span><a href=""><?php echo  $url_edit;   ?></a><a href=""><?php echo $url_title;  ?></a></span>
  <br>
 <!--  <a href="#"></a> -->
</div>
<!-- <div>
...
document.getElementById('btn1').innerHTML=value;
 ...
 $('#add').click(function(e){
  e.preventDefault();
      document.getElementById('crud_table').style.display = "block";
 });
 });
    $(document).ready(function(e){
 $(document).on('click', '.remove', function(e){
  ...
  //alert('ssss');
    ...
    $(document).ready(function (e) {
  $('#uploadForm1').click(function(e){
  e.preventDefault();
  
    var fid_edit =$("#fid_edit").val();
    var category_name1 =$("#category_name").val();
    if (category_name1 != "") {
    $.ajax({
          url: "upload1.php",
      type: "POST",
      data:{category_name1:category_name1,fid_edit:fid_edit},
      // contentType: false,
   //       cache: false,
      // processData:false,
      //dataType:"json",
