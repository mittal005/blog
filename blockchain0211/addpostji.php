...
$fid_insert="INSERT INTO category(selectCategory,categoryName,parentcategory)VALUES('$c','$category_name','$category_type')";
...
// ";
    ...
    exit();
            ...
            // OR REMOVE IT BY YOUR METHOD
                                              ...
                                              ?>
            <input type="checkbox" class="mar_top_20" name="selectCategory[]" id="selectCategory_ajax" value="<?php echo $value;    ?>"> <?php echo $value;
...
<div id="ncategory" class=" mar_top_20">
  <input type="text" class="form-control mar_top_20"  name="category_name_ajax" id="category_name_ajax">
  <div id="category_name_ajax1">   
  </div>
...
$query="SELECT * FROM posts WHERE id =113";
...
while($row=mysqli_fetch_array($select_images)) {
  ...
  <?php
   echo '<div class="col-md-1 imagebox">
    <a class="dropdown-item" name="edit" id="<?php echo $id; ?>"><img src="gallery/'.$image.'" width="150%"></a>
    </div>';
 
  ?>
 <!-- <input type="text" name="file" id="file"  value="<?php //echo $image;   ?>"> -->
 <!-- <a href=""></a> -->
<!--  -->
<a class="edit_data" id="<?php echo $id; ?>" >SELECT</a>

<div id="uploadFormLayer">
<!-- <input name="userImage" type="file" class="inputFile" /> -->

<input type="text" name="employee_id" value="113">
<br/>
      ...
      success: function(data)
        {
          // alert(data);
          //alert(data);
          var html_code = "<input type='text'>";
   html_code += "<input type='submit' value='add'>";
   html_code += "<input type='submit'  value='clear' class='remove'>";
      //$('#category_name_ajax1').prepend(html_code);
      //selectCategory_ajax
      //$('#selectCategory_ajax').prepend("success");
      $('input[type="checkbox"]').append(data);
      $("#category_name_ajax").val("");
      // $("div[id='crud_table']").hide();
      //$("#selectCategory_ajax").val(data);

      
      //$('#crud_table').prop("display", block);
