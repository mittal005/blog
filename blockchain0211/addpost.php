...
$fid_query=mysqli_query($connection,$fid_select);
 ...
 $query="INSERT INTO posts(fid,username,user_id,Title,Content,Status,Visibility,Format,draftTime,selectCategory,seo_title,description, url,seo_schema,image, onlyDate)VALUES('$fid','$username','$user_id','$addTitle','$postContent','$statusdropdown','$visible','$x','$current_time','$c','$seo_title','$description','$url','$schema','$post_image','$current_time')";
...
<div class="card-header" id="categoryone">
     ...
     <div id="cat" class="collapse show" aria-labelledby="categoryone" data-parent="#category">
       <div class="card-body">
<div class = "tabinator" id = "content12">
...
while($row=mysqli_fetch_array($select_images)) {
  ...
  <?php
   echo '<div class="col-md-1 imagebox">
    <a class="edit_data" name="edit" id="<?php echo $id; ?>"><img src="gallery/'.$image.'" width="100%"></a>
    </div>';
  ?>
  <div>
<a class="edit_data" id="<?php echo $id; ?>" >SELECT</a> 
<a href="sample_content.php?edit=<?php echo $id;  ?>">Edit</a></div>
<?php 
}
?>
</div>
