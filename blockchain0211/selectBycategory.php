...
//     $select_by_category_query="SELECT posts.id, posts.Title, posts.username, category.selectCategory, posts.onlyDate 
// FROM posts
//  INNER JOIN category ON posts.username='{$selectByAuthor}' AND  posts.Format='{$selectByFormat}' AND category.categoryName='{$selectByCategory}'";

 //$select_by_category_query="SELECT * FROM category WHERE categoryName='{$selectByCategory}'";
    // $select_by_category_query="SELECT id,selectCategory FROM category";
...
//   $select_by_category_query="SELECT * FROM category
// WHERE selectCategory LIKE '{$selectByCategory}'";
 // $show_by_category_query=mysqli_query($connection,$select_by_category_query);
 //  if (!$show_by_category_query) {
 //    printf("Error: %s\n", mysqli_error($connection));
 //    exit();
...
//echo $count=mysqli_num_rows($show_by_category_query);
$select_by_category_query1="SELECT * FROM posts  WHERE fid='{$id}' AND username='{$selectByAuthor}' AND Format='{$selectByFormat}'";
